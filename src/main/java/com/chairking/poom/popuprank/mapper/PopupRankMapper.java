...
public interface PopupRankMapper {
    @Select("select count(l.BOARD_NO) likecount,l.BOARD_NO,b.BOARD_TITLE,m.MEMBER_NICKNAME from LIKES l join BOARD B on l.BOARD_NO = B.BOARD_NO join MEMBER m on m.MEMBER_ID = b.MEMBER_ID where (l.LIKES_TIME between sysdate-7 and sysdate) and (b.DEL_STATUS='0') group by l.BOARD_NO,b.BOARD_TITLE,m.MEMBER_NICKNAME order by likecount desc")
